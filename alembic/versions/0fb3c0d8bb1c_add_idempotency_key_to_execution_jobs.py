...
down_revision: Union[str, None] = 'ff90d6695e6a'
...
def upgrade() -> None:
    ...
    op.add_column('rank_evaluations', sa.Column('technical_fit', sa.JSON().with_variant(postgresql.JSONB(astext_type=sa.Text()), 'postgresql'), nullable=True))
    op.add_column('rank_evaluations', sa.Column('relevant_experience', sa.JSON().with_variant(postgresql.JSONB(astext_type=sa.Text()), 'postgresql'), nullable=True))
    op.add_column('rank_evaluations', sa.Column('constraints_fit', sa.JSON().with_variant(postgresql.JSONB(astext_type=sa.Text()), 'postgresql'), nullable=True))
    op.add_column('rank_evaluations', sa.Column('career_alignment', sa.JSON().with_variant(postgresql.JSONB(astext_type=sa.Text()), 'postgresql'), nullable=True))
    op.add_column('rank_evaluations', sa.Column('behavioral_fit', sa.JSON().with_variant(postgresql.JSONB(astext_type=sa.Text()), 'postgresql'), nullable=True))
